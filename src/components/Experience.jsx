      ...
      <div>
        ...
        <div>
          <ul>
            ...
            <li>
              Developed efficient and sustainable web applications aligned with
              business objectives and client requirements using PHP Laravel,
              React JS, and MySQL.
            </li>
            <li>
            ...
            <li>
              Collaborated through GitHub to streamline and enhance development
              processes.
            </li>
